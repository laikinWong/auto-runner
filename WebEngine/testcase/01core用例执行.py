    ...
    "cases": [
{
            ...
            "steps": [
                ...
                },
                {
                    ...
                    "method": "fill_value",
                    "params": {
                        'locator': '//input[@ng-model="tenant.userName"]',
                        'value': "${{username}}"
                    }
                },
                {
                ...
                },
                {
                    ...
                    "method": "click_ele",
                    "params": {
                        "locator": "li.add-btn[ng-click='confirmAdd(4)']"
                    }
                },
                {
                    "desc": "等待1秒",
                ...
                },
                {
                    ...
                    "method": "fill_value",
                    "params": {
                        'locator': '//input[@ng-model="user.password"]',
                        'value': "${{password}}"
                    }
                },
                {
                ...
                },
                {
                    ...
                    "params": {
                        "expect_results": "http://qdy.ysy123.cn/#/main"
                    }
                }
            ]
        }
